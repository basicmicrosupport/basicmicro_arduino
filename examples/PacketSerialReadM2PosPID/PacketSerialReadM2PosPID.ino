/**
 * Basicmicro Library Example: READM2POSPID (64)
 *
 * Demonstrates reading the current Position PID control parameters for Motor 2.
...
void setup() {
  ...
  Serial.println("Basicmicro READM2POSPID Example");
  ...
  Serial.println("Attempting to read Motor 2 Position PID parameters...");
}
...
void loop() {
  ...
  // Attempt to read the Position PID parameters for Motor 2
  // The function returns true on success, false on failure.
  // The parameters are stored in the provided variables.
  bool success = controller.ReadM2PositionPID(MOTOR_ADDRESS, read_Kp, read_Ki, read_Kd, read_KiMax, read_DeadZone, read_Min, read_Max);

  if (success) {
    Serial.println("READM2POSPID command successful.");
    Serial.println("Motor 2 Position PID Parameters:");
    ...
    Serial.println("READM2POSPID command failed.");
