/**
 * Basicmicro Library Example: READM1PID (55)
 *
 * Demonstrates reading the current Velocity PID control parameters for Motor 1.
...
void setup() {
  ...
  Serial.println("Basicmicro READM1PID Example");
  ...
  Serial.println("Attempting to read Motor 1 Velocity PID parameters...");
}
...
void loop() {
  ...
  // Attempt to read the Velocity PID parameters for Motor 1
  // The function returns true on success, false on failure.
  // The parameters are stored in the provided variables.
  bool success = controller.ReadM1VelocityPID(MOTOR_ADDRESS, read_Kp, read_Ki, read_Kd, read_qpps);

  if (success) {
    Serial.println("READM1PID command successful.");
    Serial.println("Motor 1 Velocity PID Parameters:");
    ...
    Serial.println("READM1PID command failed.");
